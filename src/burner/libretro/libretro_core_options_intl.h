...
#define FBA2012CPS1_FRAMESKIP_LABEL_AST "Saltu de cuadros"
...
#define FBA2012CPS1_FRAMESKIP_LABEL_BE "Прапусканне кадраў"
...
#define FBA2012CPS1_CPU_SPEED_ADJUST_LABEL_BG NULL
#define FBA2012CPS1_CPU_SPEED_ADJUST_INFO_0_BG NULL
#define FBA2012CPS1_HISCORES_LABEL_BG NULL
#define FBA2012CPS1_HISCORES_INFO_0_BG NULL
#define FBA2012CPS1_ASPECT_LABEL_BG NULL
#define FBA2012CPS1_ASPECT_INFO_0_BG NULL
#define OPTION_VAL_DAR_BG NULL
#define OPTION_VAL_PAR_BG NULL
#define FBA2012CPS1_AUTO_ROTATE_LABEL_BG NULL
#define FBA2012CPS1_AUTO_ROTATE_INFO_0_BG NULL
#define FBA2012CPS1_LOWPASS_FILTER_LABEL_BG NULL
#define FBA2012CPS1_LOWPASS_FILTER_INFO_0_BG NULL
#define FBA2012CPS1_LOWPASS_RANGE_LABEL_BG NULL
#define FBA2012CPS1_LOWPASS_RANGE_INFO_0_BG NULL
#define FBA2012CPS1_FRAMESKIP_LABEL_BG NULL
#define FBA2012CPS1_FRAMESKIP_INFO_0_BG NULL
#define OPTION_VAL_AUTO_BG NULL
#define OPTION_VAL_MANUAL_BG NULL
#define FBA2012CPS1_FRAMESKIP_THRESHOLD_LABEL_BG NULL
#define FBA2012CPS1_FRAMESKIP_THRESHOLD_INFO_0_BG NULL
#define FBA2012CPS1_DIAGNOSTICS_LABEL_BG NULL
#define FBA2012CPS1_DIAGNOSTICS_INFO_0_BG NULL
...
struct retro_core_option_v2_definition option_defs_bg[] = {
   {
      "fba2012cps1_cpu_speed_adjust",
      FBA2012CPS1_CPU_SPEED_ADJUST_LABEL_BG,
      NULL,
      FBA2012CPS1_CPU_SPEED_ADJUST_INFO_0_BG,
      NULL,
      NULL,
      {
         { "100", NULL },
   ...
   {
      "fba2012cps1_hiscores",
      FBA2012CPS1_HISCORES_LABEL_BG,
      NULL,
      FBA2012CPS1_HISCORES_INFO_0_BG,
      NULL,
      NULL,
      {
         { "enabled",  NULL },
   ...
   {
      "fba2012cps1_aspect",
      FBA2012CPS1_ASPECT_LABEL_BG,
      NULL,
      FBA2012CPS1_ASPECT_INFO_0_BG,
      NULL,
      NULL,
      {
   ...
   {
      "fba2012cps1_auto_rotate",
      FBA2012CPS1_AUTO_ROTATE_LABEL_BG,
      NULL,
      FBA2012CPS1_AUTO_ROTATE_INFO_0_BG,
      NULL,
      NULL,
      {
         { "enabled",  NULL },
   ...
   {
      "fba2012cps1_lowpass_filter",
      FBA2012CPS1_LOWPASS_FILTER_LABEL_BG,
      NULL,
      FBA2012CPS1_LOWPASS_FILTER_INFO_0_BG,
      NULL,
      NULL,
      {
         { "disabled", NULL },
   ...
   {
      "fba2012cps1_lowpass_range",
      FBA2012CPS1_LOWPASS_RANGE_LABEL_BG,
      NULL,
      FBA2012CPS1_LOWPASS_RANGE_INFO_0_BG,
      NULL,
      NULL,
      {
         { "5",  NULL },
   ...
   {
      "fba2012cps1_frameskip",
      FBA2012CPS1_FRAMESKIP_LABEL_BG,
      NULL,
      FBA2012CPS1_FRAMESKIP_INFO_0_BG,
      NULL,
      NULL,
      {
         { "disabled", NULL },
   ...
   {
      "fba2012cps1_frameskip_threshold",
      FBA2012CPS1_FRAMESKIP_THRESHOLD_LABEL_BG,
      NULL,
      FBA2012CPS1_FRAMESKIP_THRESHOLD_INFO_0_BG,
      NULL,
      NULL,
      {
         { "15", NULL },
   ...
   {
      "fba2012cps1_diagnostics",
      FBA2012CPS1_DIAGNOSTICS_LABEL_BG,
      NULL,
      FBA2012CPS1_DIAGNOSTICS_INFO_0_BG,
      NULL,
      NULL,
      {
         { "disabled", NULL },
...
#define FBA2012CPS1_CPU_SPEED_ADJUST_INFO_0_CA "Augmenta la velocitat de la CPU emulada. Pot reduir els alentiments en els jocs, però pot causar errors gràfics."
#define FBA2012CPS1_HISCORES_LABEL_CA "Màximes puntuacions"
#define FBA2012CPS1_HISCORES_INFO_0_CA "Habilitar el desat de les puntuacions més altes en els jocs que ho permeten. És necessari un fitxer 'hiscore.dat' en la carpeta 'system/fbalpha2012/."
...
#define FBA2012CPS1_LOWPASS_FILTER_INFO_0_CA "Habilita un filtre d'àudio passabaix per suavitzar els pics de so en alguns jocs arcade."
#define FBA2012CPS1_LOWPASS_RANGE_LABEL_CA "Nivell del filtre d'àudio (%)"
#define FBA2012CPS1_LOWPASS_RANGE_INFO_0_CA "Especifica el tall de freqüència del filtre d'àudio passabaix. Un valor alt es pot captar com un filtre amb més força, perquè esmorteeix un rang més gran de freqüències altes."
#define FBA2012CPS1_FRAMESKIP_LABEL_CA "Ometre fotogrames"
#define FBA2012CPS1_FRAMESKIP_INFO_0_CA "Omet fotogrames per no saturar la memòria intermèdia de l'àudio. Millora el rendiment a canvi de perdre fluïdesa visual. Selecció automàtica omet fotogrames a petició del front-end. El valor manual ajusta el llindar d'omissió de fotogrames (%)."
...
#define FBA2012CPS1_DIAGNOSTICS_INFO_0_CA "Activa aquesta opció i torna al joc per obrir el menú de servei."
...
#define FBA2012CPS1_FRAMESKIP_THRESHOLD_INFO_0_ID "Saat 'Lewati Bingkai' diatur ke 'Manual', tentukan (persentase) ambang batas hunian dapar audio di bawah untuk melewati berapa bingkai. Nilai lebih tinggi akan mengurangi bunyi derak dengan cara membuat laju bingkai sering anjlok."
...
#define FBA2012CPS1_CPU_SPEED_ADJUST_INFO_0_PT_BR "Aumenta a velocidade (overclock) da CPU emulada. Pode reduzir a lentidão, mas pode causar falhas."
#define FBA2012CPS1_HISCORES_LABEL_PT_BR "Pontuações"
#define FBA2012CPS1_HISCORES_INFO_0_PT_BR "Salva as melhores pontuações em jogos compatíveis.\nOBSERVAÇÃO: requer arquivo \"hiscore.dat\" na pasta \"system/fbalpha2012/\"."
#define FBA2012CPS1_ASPECT_LABEL_PT_BR "Proporção de tela do núcleo"
#define FBA2012CPS1_ASPECT_INFO_0_PT_BR "Define a proporção de tela prioritária do conteúdo.\nOBSERVAÇÃO: requer \"Fornecida pelo núcleo\" ativada nas configurações de vídeo."
#define OPTION_VAL_DAR_PT_BR "Proporção de tela (DAR)"
#define OPTION_VAL_PAR_PT_BR "Proporção de píxel (PAR)"
#define FBA2012CPS1_AUTO_ROTATE_LABEL_PT_BR "Rotacionar jogos verticais (requer reinício)"
#define FBA2012CPS1_AUTO_ROTATE_INFO_0_PT_BR "Gira a tela automaticamente ao executar jogos com alinhamento vertical. Ao ser desativada, a entrada do direcional digital (D-Pad) será girada para combinar com as direções exibidas na tela."
#define FBA2012CPS1_LOWPASS_FILTER_LABEL_PT_BR "Filtro de áudio"
#define FBA2012CPS1_LOWPASS_FILTER_INFO_0_PT_BR "Ativa um filtro de áudio passa-baixo para suavizar a estridência do som de alguns jogos de fliperama."
#define FBA2012CPS1_LOWPASS_RANGE_LABEL_PT_BR "Filtro de áudio (%)"
#define FBA2012CPS1_LOWPASS_RANGE_INFO_0_PT_BR "Especifica a frequência de corte do filtro de áudio passa-baixo. Um valor mais alto aumenta a \"força\" percebida do filtro, uma vez que uma faixa mais ampla do espectro de alta frequência é atenuada."
#define FBA2012CPS1_FRAMESKIP_LABEL_PT_BR "Pulo de quadro"
#define FBA2012CPS1_FRAMESKIP_INFO_0_PT_BR "Ignora quadros para evitar o esvaziamento da memória intermédia (buffer) do áudio (corte no áudio). Melhora o desempenho ao custo da suavidade visual. A opção \"Automático\" ignora os quadros quando aconselhado pela interface. \"Manual\" usa a configuração \"Limite do pulo de quadro (%)\"."
...
#define FBA2012CPS1_FRAMESKIP_THRESHOLD_INFO_0_PT_BR "Ao configurar \"Pulo de quadro\" como \"Manual\", especifica o limite da memória intermédia (buffer) de áudio em porcentagem, os quadros fora da porcentagem serão ignorados. Valores maiores reduzem o risco de engasgo por descartar quadros com mais frequência."
#define FBA2012CPS1_DIAGNOSTICS_LABEL_PT_BR "Entrada de assistência"
#define FBA2012CPS1_DIAGNOSTICS_INFO_0_PT_BR "\"LIGADO\": continua o conteúdo ao abrir o menu de assistência."
